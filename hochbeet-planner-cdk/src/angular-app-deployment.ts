...
interface AngularAppDeploymentProps {
  /**
...
export class AngularAppDeployment extends Construct {
  constructor(scope: Construct, id: string, props: AngularAppDeploymentProps) {
    super(scope, id);
  ...
  private createDeployment(
    props: AngularAppDeploymentProps,
